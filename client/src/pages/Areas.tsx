        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-card p-10 md:p-16 rounded-2xl border border-border max-w-4xl mx-auto text-center shadow-xl">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Even if your town isn't explicitly listed above, if you are within a 20-mile radius of Darlington, we can likely help. Contact us to confirm coverage and arrange a free quote.
            </p>
            <p className="text-sm text-muted-foreground">
              SEO Keywords: roofing company Darlington, roof repairs Darlington, re-roofing Darlington, emergency roofer Darlington, chimney repairs Darlington, roofers Newton Aycliffe, roofers Bishop Auckland.
            </p>
          </div>
