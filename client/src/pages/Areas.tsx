...
export default function AreasPage() {
  const areas = [
    ...
    "Stockton-on-Tees", "Middlesbrough", "Hartlepool", 
    "Durham", "Yarm", "Redcar", "Northallerton"
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-card p-10 md:p-16 rounded-2xl border border-border max-w-4xl mx-auto text-center shadow-xl">
            ...
            <p className="text-sm text-muted-foreground">
              Top service areas: Darlington, Newton Aycliffe, Bishop Auckland, Stockton-on-Tees, Middlesbrough, Hartlepool, Durham, Yarm, Redcar, and Northallerton.
            </p>
          </div>
